        ...
        return (
            <div> 
                ...
                <ul className="list-group">
                    ...
                    {this.props.bio.followers > -1 && <li className="list-group-item"> Followers: {this.props.bio.followers} </li>}
                    {this.props.bio.following > -1 && <li className="list-group-item"> Following: {this.props.bio.following} </li>}
                    {this.props.bio.public_repos > -1 && <li className="list-group-item"> Public Repos: {this.props.bio.public_repos} </li>}
